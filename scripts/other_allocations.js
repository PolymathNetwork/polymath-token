...
function readFile() {
  ...
  switch (ALLOC_TYPE) {
      case 0: //PRESALE
          stream = fs.createReadStream("scripts/data/presale_distrib.csv");
          break;
      case 1: //FOUNDER
          stream = fs.createReadStream("scripts/data/founder_distrib.csv");
          break;
      case 2: // AIRDROP
          break;
      case 3: // ADVISOR
          stream = fs.createReadStream("scripts/data/advisor_distrib.csv");
          break;
      case 4: // RESERVE
          stream = fs.createReadStream("scripts/data/reserve_distrib.csv");
          break;
      case 5: // BONUS1
          stream = fs.createReadStream("scripts/data/bonus1_distrib.csv");
          break;
      case 6: // BONUS2
          stream = fs.createReadStream("scripts/data/bonus2_distrib.csv");
          break;
      case 7: // BONUS3
          stream = fs.createReadStream("scripts/data/bonus3_distrib.csv");
          break;
      default:
